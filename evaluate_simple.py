...
evaluation_file_name = f"{real_data_file_name.split('.')[0]}_{synthetic_data_file_name.split('.')[0]}_{current_timestamp}.txt"
...
with open(evaluation_file_path, 'w') as file:
    ...
    file.write("Synthetic data path: " + synthetic_data_file_path + '\n')
